...
public class Hornitzaileak extends JFrame {
	...
	public static String value = "hornitzaileformulario";
	private JTextField textField;
	private JTextField TelZenbakia;
	private JTextField Izena;
	private JTextField HornitzaileMota;
	private JTextField Helbidea;
	private JTextField Zerbitzua;
	...
	public Hornitzaileak() {
		...
		Kendu.setBounds(806, 392, 85, 21);
		contentPane.add(Kendu);
		
		JLabel ID = new JLabel("NAN:");
		ID.setForeground(new Color(255, 128, 64));
		ID.setBounds(637, 376, 120, 52);
		contentPane.add(ID);
		
		NAN = new JTextField();
		NAN.setBounds(675, 393, 96, 19);
		contentPane.add(NAN);
		NAN.setColumns(10);
		...
		Update.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					Queryak.Update(TelZenbakia, NAN, Izena, HornitzaileMota, Helbidea, Zerbitzua);
		...
		Gehitu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					Queryak.Gehitu(TelZenbakia, NAN, Izena, HornitzaileMota, Helbidea, Zerbitzua);
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
		...
		Gehitu.setBounds(806, 423, 85, 21);
		contentPane.add(Gehitu);
			
		TelZenbakia = new JTextField();
		TelZenbakia.setColumns(10);
		TelZenbakia.setBounds(59, 423, 85, 19);
		contentPane.add(TelZenbakia);
		
		Izena = new JTextField();
		Izena.setColumns(10);
		Izena.setBounds(154, 424, 85, 19);
		contentPane.add(Izena);
		
		HornitzaileMota = new JTextField();
		HornitzaileMota.setColumns(10);
		HornitzaileMota.setBounds(348, 424, 77, 19);
		contentPane.add(HornitzaileMota);
		
		Helbidea = new JTextField();
		Helbidea.setColumns(10);
		Helbidea.setBounds(435, 423, 85, 19);
		contentPane.add(Helbidea);
		
		Zerbitzua = new JTextField();
		Zerbitzua.setColumns(10);
		Zerbitzua.setBounds(530, 423, 85, 19);
		contentPane.add(Zerbitzua);
